...
public class RecentMediaStorage {
  ...
  public static final String ALL_COLUMNS[] = new String[] {
      Entry.COLUMN_NAME_ID + " as _id", Entry.COLUMN_NAME_ID, Entry.COLUMN_NAME_URL, Entry.COLUMN_NAME_NAME, Entry.COLUMN_NAME_LAST_ACCESS
  };
  ...
  public static class CursorLoader extends AsyncTaskLoader<Cursor> {
    ...
    @Override public Cursor loadInBackground() {
      ...
      return db.query(Entry.TABLE_NAME, ALL_COLUMNS, null, null, null, null, Entry.COLUMN_NAME_LAST_ACCESS + " DESC", "100");
    }
